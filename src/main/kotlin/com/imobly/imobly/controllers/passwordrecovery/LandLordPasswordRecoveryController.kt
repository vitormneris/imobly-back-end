...
import com.imobly.imobly.services.recoverypassword.LandLordPasswordRecoveryService
...
@RestController
@RequestMapping("/redefinirsenha/locador")
class LandLordPasswordRecoveryController (
    private val service: LandLordPasswordRecoveryService
) {
